...
\title{SOK - Sichere Betriebssystemarchitekturen}% A secure operating system architecture}
...
\maketitle
  ...
  \section{Sicherheitsmechanismen} \label{sec:secure}
    ...
    \subsection{Protection Rings} \label{sec:secure:protectrings}
      ...
      \subsubsection{Multics}  
        ...
        F\"ur Multics Nutzer erscheint der Speicher als eingeschlosser gro\ss er unabh\"angiger linearer Kernspeicher,
  ...
  \section{Weitere sichere Systeme} \label{sec:other}
    ...
    \subsection{EROS}      
      ...
      Eine \textit{protection domain} wie bereits erw\"ahnt ist eine Menge von \textit{capabilities}, welche von einem Subsystem zug\"anglich sind.
      ...
      Es existiert ein einheitliches Interface, was bedeutet das alle \textit{capabilities} die selben Argumente annehmen,
    ...
    \subsection{Asbestos}        
      ...
      \textit{capability} basierende Senderechten erreicht. Das Resultierende Port-Label System unterst\"utzt also \textit{capability} \"ahnliche Senderechte.
