...
\maketitle
  ...
  \section{Sicherheitsmechanismen} \label{sec:secure}
    ...
    \subsection{Access bits oder Matrix} \label{sec:secure:access}
      ...
      \subsubsection{Unix}
        ...
        Plan 9's Au­then­ti­fi­ka­ti­on erm\"oglicht eine sogenannte \textit{Spricht-f\"ur} Beziehung, sodass ein Benutzer die Befugnis eines anderen besitzt.
  ...
  \section{Minimalistische Kernel-Varianten} \label{sec:other} %TODO change section
    Unabh\"angig von den zuvor bereits erw\"ahnten Zugriffsmechanismen wollten einige Systementwickler und Wissenschaftler neue minimalistische Kernel
    erzeugen um somit die Sicherheit eines Systems besser zu gew\"ahrleisten. Im folgendem Abschnitt wird dabei auf die Entwicklung
    des Mikro-, Exokernels und einigen anderen Variationen eingegangen.
    %TODO change intro
    ...
    \subsection{EROS}      
      ...
      \textit{Capabilities} werden zudem auch in sogenannten \textit{nodes} gespeichert, wobei ein \textit{node} 32 \textit{capabilities} speichern kann.
       Adressr\"aume werden in B\"aume aufgebaut, 
